...
testRNApp is available under the MIT license. See the LICENSE file for more info.

## 附录：跨平台RN开发的React规范（ES6）
**播客**

- [RN 娱乐也要有深度](http://blog.csdn.net/yuanwenyan/article/details/78653606)
